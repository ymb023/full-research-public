---
name: full-research
description: Use when the user asks for 综合研究, 行业研究, 政策研究, 软科学研究, 课题研究, 趋势/影响分析, 判断命题是否成立, 研究报告, 成熟报告体例, 成稿, 证据矩阵, 反方审稿, 研究假设, or 分层建议, especially when the model must form an evidence-backed judgment under uncertainty.
---
